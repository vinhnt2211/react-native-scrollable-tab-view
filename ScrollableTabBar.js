...
const ScrollableTabBar = createReactClass({
  ...
  getInitialState() {
    let minWidth = 80;
    if (this.props.tabs && this.props.tabs.length * minWidth > WINDOW_WIDTH) {
      const temp = WINDOW_WIDTH % minWidth;
      while (WINDOW_WIDTH % minWidth < 25 || WINDOW_WIDTH % minWidth > 65) {
        minWidth += 1;
      }
    }
